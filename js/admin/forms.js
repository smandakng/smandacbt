  ...
  showConfirmation("Buat Jadwal", `
    <div class="space-y-3 text-base text-left text-slate-800 dark:text-slate-100">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
        <label class="flex items-center gap-2 text-sm sm:text-base font-bold text-slate-800 dark:text-slate-100 whitespace-nowrap">
          <input type="checkbox" id="s-as" checked class="rounded text-primary">
          <span>Acak Soal</span>
        </label>
        <label class="flex items-center gap-2 text-sm sm:text-base font-bold text-slate-800 dark:text-slate-100 whitespace-nowrap">
          <input type="checkbox" id="s-aj" checked class="rounded text-primary">
