function setupInteractiveListeners() {
  ...
  const mobileCombinedMenuBtn = document.getElementById('mobileCombinedMenuBtn');
  const mobileCombinedMenu = document.getElementById('mobileCombinedMenu');
  if (mobileCombinedMenuBtn && mobileCombinedMenu) {
    document.addEventListener('click', (e) => {
      if (!mobileCombinedMenu.classList.contains('hidden') && !mobileCombinedMenuBtn.contains(e.target) && !mobileCombinedMenu.contains(e.target)) {
        mobileCombinedMenu.classList.add('hidden');
      }
    });
  }
